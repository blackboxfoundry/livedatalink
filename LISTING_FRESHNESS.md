...
| mcpservers.org (primary and locale mirrors) | Mixed refresh: title still says 62 tools and the pricing table still says $0.01/query overage, while the body now says 284 tools / 59 domains and links to current docs. | Use the primary listing's “request update”/claim path after wrapper update; verify one locale and the primary. | Refresh request submitted 2026-08-16; partial update observed 2026-08-17, pricing/title correction still pending | Weekly until corrected, then quarterly |
